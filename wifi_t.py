...
# Sfile ='/Users/user01/python_script/SecLists-master/Passwords/xato-net-10-million-passwords-1000000.txt'
# with open(Sfile) as file_obj:
#     passwords = file_obj.readlines()
#
# for password in passwords:
#     print(password)


#networks = Cell.all('en0')
#print(networks)
